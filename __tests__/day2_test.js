...
var Day2$AdventOfCode2017 = require("../src/day2.js");
...
describe("Day2", (function () {
        Jest.test("provided example", (function () {
                return Jest.Expect[/* toBe */2](18)(Jest.Expect[/* expect */0](Day2$AdventOfCode2017.solution(exampleGrid)));
              }));
        return Jest.test("puzzle", (function () {
                      return Jest.Expect[/* toBe */2](41887)(Jest.Expect[/* expect */0](Day2$AdventOfCode2017.solution(puzzleInput)));
                    }));
      }));
